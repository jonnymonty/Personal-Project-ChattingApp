...
{
    /// <summary>
    /// Stores and retrieves information about the client application such as login credentials, messages, settings and so on
    ...
    public class BaseClientDataStore : IClientDataStore
    {
        ...
        /// <summary>
        /// The database context for the client datastore
        /// </summary>
        ...
        /// </summary>
        /// <returns>Returns the login credentials if they exist or null of they do not exist</returns>
